...
$.getJSON(window.location.origin +'/dataprofile', function(res){
    ...
    // $('#myprofile').prop('src', '/asset/'+res.data.picture)
})
                ...
                <div class="flex flex-col px-2">
                    <a href="/explore-detail/${x.id}">
                        <div class="w-[363px] h-[192px] bg-bgcolor2 overflow-hidden">
                            <img src="/assets/${x.foto}" alt="" class="w-full transition duration-500 ease-in-out hover:scale-105 rounded-md">
                        </div>
                    </a>
                    <div class="flex flex-wrap items-center justify-between px-2 mt-2">
                        ...
                        <div>
                            ...
                            <a href="/hapus/${x.id}" class="px-1 py-0 bg-red-500 rounded-md "><i class="bi bi-trash3-fill"></i></a>
                            <a href="/edit/${x.id}" class="px-1 py-0 bg-blue-500 rounded-md "><i class="bi bi-pencil-fill"></i></a>
                        </div>
                    </div>
                </div>
            </div>
